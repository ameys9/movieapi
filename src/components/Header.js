...
const handleSub = (event) => {
  ...
  <Link to="/" className="flex items-center">
      <img src={Logo} className="h-8 mr-3 border rounded" alt="Flowbite Logo" />
  ...
  <div className="flex md:order-2">
    ...
    <div className="relative hidden md:block">
      ...
      <input type="text" id="search-navbar" autoComplete="off" name="search"  className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..."/>
      </form>
    </div>
